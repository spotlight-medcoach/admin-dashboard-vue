            ...
            <div class="modal-wrapper" role="document">
                <div class="modal-container">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn accept" data-dismiss="modal" @click="selectSimulator">{{textButton}}</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
export default {
    props: ['textTitle', 'textBody', 'textButton', 'action', 'allSimulators', 'isBusy'],
    data() {
        return {
            simulatorSelected: ''
        }
    ...
    methods: {
        selectSimulator() {
            this.$emit('update:data', this.simulatorSelected)
            this.$emit('addSimu')
        }
    }
}
