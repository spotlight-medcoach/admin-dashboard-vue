            ...
            <div class="modal-wrapper" role="document">
                <div class="modal-container">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn accept" data-dismiss="modal" @click="$emit('pay')"><i class="fas fa-check-circle mx-1"></i> {{textButton}}</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
export default {
    props: ['textTitle', 'textBody', 'name', 'money', 'textButton', 'isBusy']
}
</script>
