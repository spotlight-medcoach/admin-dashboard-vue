  ...
  methods: {
    async getUser() {
      try {
        ...
        let user_response = await this.$axios.get('/getOneAdminUser', {
    ...
    async getCountries() {
      try {
        ...
        let contriesResponse = await this.$axios.get(
          'https://vsbs6hgmxf.execute-api.us-west-2.amazonaws.com/refinery/api/countries'
        );
