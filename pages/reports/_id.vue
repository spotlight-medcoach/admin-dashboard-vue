        ...
        <div class="report-container">
            <div class="title-container">
                ...
                <!-- <div v-if="!loading" class="buttons">
                    ...
                    <button type="button" class="btn retro-btn" @click="retroAlert" disabled><i class="fas fa-exclamation"></i> Dar retroalimentación</button>
                </div> -->
            </div>
            ...
            <div v-if="!loading" class="finish-report">
                <button class="btn" @click="updateCaseConfirm"><i class="fas fa-check-circle"></i>Actualizar caso y finalizar reporte</button>
            </div>
        </div>
    ...
    methods: {
        async getReportDetails() {
            try {
                ...
                let reportResponse = await this.$axios.get('/getOneReport', { params: { report_id: this.$route.params.id } });
                
                this.reportDetails = reportResponse.data.payload
                this.caseDetails = reportResponse.data.payload.case_id;
                this.contentDescription = reportResponse.data.payload.case_id.content.quill;
        ...
        updateCaseConfirm() {
            ...
            this.button = 'Actualizar caso y finalizar reporte'
        },
        async updateCase() {
            try {
