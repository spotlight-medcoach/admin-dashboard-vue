    ...
    <div class="case-container">
      ...
      <div class="inputs-container topic">
        <div class="topic-container">
          <h3>Tema</h3>
          <select
            v-model="topicBubbleSelected"
            class="js-example-basic-single"
            @change="filterSubtopics(topicBubbleSelected)"
          >
            <option value="" disabled selected>Tema</option>
            <option :value="top.bubble_id" v-for="top in topics" :key="top._id">
              {{ top.name }}
            </option>
          </select>
        </div>
        <div class="subtopic-container">
          ...
          <select
            ...
            class="js-example-basic-single"
            @change="changeSubtopic(subtopicBubbleSelected)"
          >
      ...
      <div class="questions-container">
        ...
        <div class="add-question-container">
          <button class="btn" @click="requestCase">
  ...
  methods: {
    ...
    async requestCase() {
      try {
        if (
          this.name.trim() == '' ||
          this.topicBubbleSelected == '' ||
          this.subtopicBubbleSelected == '' ||
          this.languageSelected == '' ||
          this.contentDescription.ops[0].insert.trim() == ''
        ) {
    ...
    changeSubtopic(subtopic) {
      this.subtopicFolio = this.subtopics.filter(
