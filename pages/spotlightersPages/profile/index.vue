  ...
  <div>
    ...
    <div class="profile-container">
      <div class="header-profile">
        ...
        <button v-if="disabled && !loading" class="btn" @click="editProfile">
  ...
  methods: {
    async getUserInfo() {
      try {
        ...
        this.new_university = this.universities.filter(
          (uni) => uni._id == this.userInfo.spotlighter_id.university_id
        )[0].name;
    ...
    cancel() {
      this.disabled = true;
      this.new_university = this.universities.filter(
        (uni) => uni._id == this.new_university
      )[0].name;
    },
    async saveProfile() {
      try {
