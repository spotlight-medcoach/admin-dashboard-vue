...
export default {
    ...
    methods: {
        ...
        addNewCase() {
            this.$router.push({ path: `/administratorsPages/findCase/addNewCase`, query: { length: this.cases.length } });
        },
        ...
        caseDetails(theCase) {
            this.$router.push({ path: `/administratorsPages/findCase/${theCase}` });
        },
