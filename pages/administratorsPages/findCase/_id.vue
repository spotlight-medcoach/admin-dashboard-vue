<template>
    <div>
        ...
        <div class="case-container">
            <nuxt-link to="/administratorsPages/findCase">
            ...
            <div v-if="!loading" class="questions-container">
                ...
                <div class="add-question-container">
                    <button class="btn" @click="addQuestionModal"><i class="fas fa-plus-circle"></i> Agregar pregunta</button>
                </div>
            </div>
...
import CaseBankDetailsCard from '../../../components/cards/administrators/CaseBankDetailsCard';
    ...
    methods: {
        ...
        async getCaseDetails() {
            try {
                ...
                let caseDetailsResponse = await this.$axios.get('/getCaseFromBank', { params: { case_id: this.$route.params.id } })
        ...
        discardConfirm() {
            ...
            this.bodyModal = 'Al descartar este caso, se eliminará toda la información relacionada con él. Esta \n acción no se puede deshacerse. ¿Deseas descartarlo?';
        ...
        async discardCase() {
            try {
                ...
                setTimeout(() => {
                    ...
                    this.isShowDiscardCaseModal = !this.isShowDiscardCaseModal;
                    this.busyDiscard = !this.busyDiscard;
                    this.$router.push({ path: '/administratorsPages/findCase'});
                }, 1500);
            } catch (err) {
                this.busyDiscard = !this.busyDiscard;
